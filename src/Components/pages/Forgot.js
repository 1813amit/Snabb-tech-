...
import "../style.css";
// import Forgot from './Forgotpassresend';
const Forgot = () => {
      ...
      <div className="w-full h-full flex max-[765px]:flex-col ">
        ...
        <div className="w-2/5 h-full flex flex-col items-center max-[765px]:w-full max-[765px]:h-full">
          ...
          <div className="relative cont2 w-4/5 pt-6 min-h-full flex flex-col justify-center items-center max-[920px]:h-3/6">
            ...
            <div
              className="box1 px-10 relative flex flex-col justify-start items-center lg:mt-20"
              style={{
            ...
            >
              <img src={img1} alt="" />
              <div className="flex w-full h-3/6 flex-col lg:-mt-5">
                <h1 className="font-medium text-3xl mt-6 p-4 text-center">
                  Forgot Password
                </h1>
                {/* <h2 className='font-medium text-xl pb-4 text-center'>Takes less than <span style={{color:"rgba(169, 84, 84, 1)"}}>5 minutes </span>...</h2> */}
              </div>
              <div className="w-full h-3/6 max-[765px]:h-2/5 flex flex-col">
                <div className="container mx-auto flex flex-col lg:mt-7">
                  <div className="relative flex justify-center w-full md:w-2/3 lg:w-1/2 xl:w-full mx-auto ">
                    <input
                      type="email"
                      className=" text-yellow-800 w-[300px] px-3 py-2 border-b border-yellow focus:outline-none focus:border-yellow"
                      placeholder="Email address"
                    />
                  </div>
                  <h6
                    className="lg:mt-10 text-xs mt-1 mb-1 flex text-center justify-center"
                    style={{ color: "rgba(172, 181, 189, 1)" }}
                  >
                    Please enter your login email address to receive your
                    password reset link.
                  </h6>
                </div>
              </div>
            ...
            <div
              onClick={gotolink}
              className="lg:mt-16 border-stone-900 btnal mt-4 rounded-full py-3 w-1/2 ring ring-zinc-200 flex flex-col items-center mb-4"
            >
              Get the link
            </div>
          </div>
...
//       className="box1 relative flex flex-col justify-start items-center "
//       style={{
//         width: '400px',
//         // maxWidth: '100%',
//         height: '100%',
...
//       <EmailInput />
//       <h6 className='text-xs mt-6 w-full' style={{color:"rgba(172, 181, 189, 1)"}}>Please enter your login email address to receive your password reset link.</h6>
//     </div>

//  </div>
//         </div>
//         <div onClick={gotolink} className="border-stone-900 rounded-full py-3 w-1/2 ring ring-zinc-200 flex flex-col items-center ml-20 mt-16">Get the link</div>
//         </div>
